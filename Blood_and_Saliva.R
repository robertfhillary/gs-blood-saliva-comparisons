...
keep_samps = keep_samps[which(!keep_samps %in% c("203253040183_R06C01", "203253040111_R03C01"))]
...
write.table(Table3, file="Normalisation_performance_bloodsaliva.txt", sep='\t', row.names=F)

# Save normalied dataset corresponding to ranked means - danet used here. 
saveRDS(bnnanet, file="Outputs/Normalised_Beta_Values_nanet.rds")
